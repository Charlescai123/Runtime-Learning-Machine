...
from envs.robot.gait_scheduler import gait_scheduler as gait_scheduler_lib
from envs.robot.mpc_controller import qp_torque_optimizer
...
class TorqueStanceLegController:
    ...
    def get_model_action(self):
        ...
        ddq = self._kp * (desired_q - robot_q) + self._kd * (desired_dq - robot_dq)
