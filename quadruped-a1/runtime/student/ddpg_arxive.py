...
from runtime.student.base import BaseAgent, BaseAgentParams
...
class DDPGAgent(BaseAgent):
    ...
    def __init__(self, params: DDPGAgentParams, shape_observations=5, shape_action=1, on_edge=False):
        super(DDPGAgent, self).__init__(params, shape_observations, shape_action, on_edge)
        self.params = params
