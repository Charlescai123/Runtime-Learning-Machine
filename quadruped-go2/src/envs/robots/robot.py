...
class Robot:
    ...
    def _load_urdf(self, urdf_path):
        ...
        print(f"self._world_envs: {self._world_envs}")
        print(f"self._robot_actors: {self._robot_actors}")
        print(f"self._camera_sensors: {self._camera_sensors}")
    ...
    def _post_physics_step(self):
        ...
        # print(f"actor_root_state: {actor_root_state}")
        # print(f"self._robot_actors_global_indices: {self._robot_actors_global_indices}")
        self._root_states = actor_root_state[self._robot_actors_global_indices]
