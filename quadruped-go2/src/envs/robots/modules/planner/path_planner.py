...
class PathPlanner:
    ...
    def world_to_map_frame(self, pose_in_world, env_idx=0, bev_frame=False):
        ...
        print(f"map_pos_flipped: {origin_flipped_in_map}")
    ...
    def generate_ref_trajectory(self, map_goal, occupancy_map=None, env_idx=0):
        ...
        curr_pos_w = np.asarray(self._robot.base_position[env_idx, :2])
        yaw = np.asarray(self._robot.base_orientation_rpy[env_idx, 2])
        curr_vel_w = np.asarray(self._robot.base_velocity_world_frame[env_idx, :2])
